...
public class CreateLobbyRequest implements Message {
    ...
    private final String playerName; // AJOUT : Nom du créateur
    private final int maxPlayers;
    private TypeLab labyrintheType;
    private int sizeX;
    private int sizeY;

    public CreateLobbyRequest(String lobbyName, String playerName, int maxPlayers, TypeLab labType, int sizeX, int sizeY) {
    ...
    public TypeLab getLabyrintheType() { return labyrintheType; }
